...
atualizar_frame.pack(side="top", padx=10, pady=10)
atualizar_label = tk.Label(atualizar_frame, text="ATUALIZAR DADOS DE MOTO")
...
remover_frame.pack(side="top", padx=10, pady=10) 
...
adicionar_frame.pack(side="top", padx=10, pady=10)
...
atualizar_cliente_frame.pack(side="top", padx=10, pady=10)
atualizar_cliente_label = tk.Label(atualizar_cliente_frame, text="ATUALIZAR DADOS DE CLIENTE")
...
remover_cliente_frame.pack(side="top", padx=10, pady=10)
remover_cliente_label = tk.Label(remover_cliente_frame, text="REMOVER CLIENTE")
...
adicionar_cliente_frame.pack(side="top", padx=10, pady=10)
adicionar_cliente_label = tk.Label(adicionar_cliente_frame, text="ADICIONAR CLIENTE")
...
atualizar_compra_frame.pack(side="top", padx=10, pady=10)
atualizar_compra_label = tk.Label(atualizar_compra_frame, text="ATUALIZAR DADOS DE COMPRA")
...
remover_compra_frame.pack(side="top", padx=10, pady=10)
remover_compra_label = tk.Label(remover_compra_frame, text="REMOVER COMPRA")
...
adicionar_compra_frame.pack(side="top", padx=10, pady=10)
adicionar_compra_label = tk.Label(adicionar_compra_frame, text="ADICIONAR COMPRA")
