...
# Função para criar uma aba em um notebook
def criar_aba(notebook, texto):
    frame = ttk.Frame(notebook)
    notebook.add(frame, text=texto)
    return frame

# Função para criar os frames das funcionalidades e adicionar widgets a eles
def criar_frames(notebook):
    # Frame para Moto
    frame_moto = criar_aba(notebook, "Moto")

    # Formulário para atualizar moto
    atualizar_moto_frame = tk.Frame(frame_moto)
    atualizar_moto_frame.pack()
    atualizar_moto_label = tk.Label(atualizar_moto_frame, text="Atualizar Moto")
    atualizar_moto_label.grid(row=0, column=0, columnspan=2)
    id_atualizar_label = tk.Label(atualizar_moto_frame, text="ID da Moto:")
    id_atualizar_label.grid(row=1, column=0)
    id_atualizar_entry = tk.Entry(atualizar_moto_frame)
    id_atualizar_entry.grid(row=1, column=1)
    campo_atualizar_label = tk.Label(atualizar_moto_frame, text="Campo a Atualizar:")
    campo_atualizar_label.grid(row=2, column=0)
    campo_atualizar_entry = tk.Entry(atualizar_moto_frame)
    campo_atualizar_entry.grid(row=2, column=1)
    novo_valor_atualizar_label = tk.Label(atualizar_moto_frame, text="Novo Valor:")
    novo_valor_atualizar_label.grid(row=3, column=0)
    novo_valor_atualizar_entry = tk.Entry(atualizar_moto_frame)
    novo_valor_atualizar_entry.grid(row=3, column=1)
    atualizar_button = tk.Button(atualizar_moto_frame, text="Atualizar", command=atualizar_moto)
    atualizar_button.grid(row=4, column=0, columnspan=2)

    # Formulário para remover moto
    remover_moto_frame = tk.Frame(frame_moto)
    remover_moto_frame.pack()
    remover_moto_label = tk.Label(remover_moto_frame, text="Remover Moto")
    remover_moto_label.grid(row=0, column=0, columnspan=2)
    id_remover_label = tk.Label(remover_moto_frame, text="ID da Moto:")
    id_remover_label.grid(row=1, column=0)
    id_remover_entry = tk.Entry(remover_moto_frame)
    id_remover_entry.grid(row=1, column=1)
    remover_button = tk.Button(remover_moto_frame, text="Remover", command=remover_moto)
    remover_button.grid(row=2, column=0, columnspan=2)

    # Formulário para adicionar moto
    adicionar_moto_frame = tk.Frame(frame_moto)
    adicionar_moto_frame.pack()
    adicionar_moto_label = tk.Label(adicionar_moto_frame, text="Adicionar Moto")
    adicionar_moto_label.grid(row=0, column=0, columnspan=2)
    modelo_adicionar_label = tk.Label(adicionar_moto_frame, text="Modelo:")
    modelo_adicionar_label.grid(row=1, column=0)
    modelo_adicionar_entry = tk.Entry(adicionar_moto_frame)
    modelo_adicionar_entry.grid(row=1, column=1)
    ano_adicionar_label = tk.Label(adicionar_moto_frame, text="Ano:")
    ano_adicionar_label.grid(row=2, column=0)
    ano_adicionar_entry = tk.Entry(adicionar_moto_frame)
    ano_adicionar_entry.grid(row=2, column=1)
    preco_adicionar_label = tk.Label(adicionar_moto_frame, text="Preço:")
    preco_adicionar_label.grid(row=3, column=0)
    preco_adicionar_entry = tk.Entry(adicionar_moto_frame)
    preco_adicionar_entry.grid(row=3, column=1)
    cor_adicionar_label = tk.Label(adicionar_moto_frame, text="Cor:")
    cor_adicionar_label.grid(row=4, column=0)
    cor_adicionar_entry = tk.Entry(adicionar_moto_frame)
    cor_adicionar_entry.grid(row=4, column=1)
    id_compra_adicionar_label = tk.Label(adicionar_moto_frame, text="ID da Compra (opcional):")
    id_compra_adicionar_label.grid(row=5, column=0)
    id_compra_adicionar_entry = tk.Entry(adicionar_moto_frame)
    id_compra_adicionar_entry.grid(row=5, column=1)
    adicionar_button = tk.Button(adicionar_moto_frame, text="Adicionar", command=adicionar_moto)
    ...
    atualizar_cliente_frame = tk.Frame(frame_clientes)
    ...
    remover_cliente_frame = tk.Frame(frame_clientes)
    ...
    # Formulário para adicionar dados do cliente
    adicionar_cliente_frame = tk.Frame(frame_clientes)
    ...
    # Formulário para atualizar dados da compra
    atualizar_compra_frame = tk.Frame(frame_compras)
    ...
    # Formulário para remover dados da compra
    remover_compra_frame = tk.Frame(frame_compras)
    ...
    # Formulário para adicionar dados da compra
    adicionar_compra_frame = tk.Frame(frame_compras)
    ...
    data_compra_adicionar_label = tk.Label(adicionar_compra_frame, text="Data da Compra:")
    data_compra_adicionar_label.grid(row=1, column=0)
...
def main():
    ...
    # Entradas para ID da Moto (Global)
    id_remover_entry = tk.Entry(janela)
    id_remover_entry.pack()  # Você pode ajustar a posição e o estilo conforme necessário

    id_atualizar_entry = tk.Entry(janela)
    id_atualizar_entry.pack()  # Você pode ajustar a posição e o estilo conforme necessário

    # Criação do frame para exibição dos resultados
    resultado_frame = ttk.Frame(janela)
    resultado_frame.pack(fill=tk.BOTH, expand=True)

    resultado_label = tk.Label(resultado_frame, text="Resultados:")
    resultado_label.pack()
    resultado_text = tk.Text(resultado_frame, state=tk.DISABLED)
    resultado_text.pack(fill=tk.BOTH, expand=True)

    criar_frames(notebook)  # Passando 'notebook' como argumento para a função
